...
@section('content')
    ...
    <div class="container-fluid">
        <form id="appointmentForm" onsubmit="handleSubmitForm(event)" method="post"
            action="{{ route('appointment.update', $appointment->id) }}" class="form-horizontal">
            @csrf
            @method('PUT')
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Attendance Plan</li>
                            </ol>
                        </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <input type="text" name="name" value="{{ $appointment->name }}"
                                                        id="name_input" class="form-control" />
                                                </div>

                                                {{-- <div class="form-group row mb-3">
                                                    <label for="date_input">Date</label>
                                                    <input type="text" name="date" id="date_input" class="form-control"
                                                        data-provide="datepicker" value="{{ $appointment->date }}">
                                                </div> --}}
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="time" id="start_from_period_1_input"
                                                                        ...
                                                                        value="{{ $appointment->start_from_period_1 }}"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="time"
                                                                        ...
                                                                        value="{{ $appointment->end_to_period_1 }}"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="delay_period_1_input"
                                                                        ...
                                                                        value="{{ $appointment->delay_period_1 }}"
                                                                        placeholder="00:00">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="time" id="start_from_period_2_input"
                                                                        value="{{ $appointment->start_from_period_2 }}"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="time"
                                                                        value="{{ $appointment->end_to_period_2 }}"
                                                                        placeholder="Enter your End Time"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="delay_period_2_input"
                                                                        name="delay_period_2"
                                                                        class="24hours-timepicker form-control"
                                                                        value="{{ $appointment->delay_period_2 }}"
                                                                        placeholder="00:00">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-9">
                                                        @foreach ($days as $day)
                                                            <div class="checkbox checkbox-success form-check-inline">
                                                                <input
                                                                    {{ in_array($day->id, explode(',', $appointment->attendance_days)) ? 'checked' : '' }}
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="checkbox checkbox-success form-check-inline">
                                                            <input type="checkbox" id="repeat-checkbox" value="1"
                                                                name="attendance_repeat"
                                                                {{ $appointment->attendance_repeat ? 'checked' : '' }}>
        ...
        const getBranchLocations = (event) => {
            ...
            $.ajax({
                ...
                success: (res) => {
                    ...
                    $('#inputLocation').val({{ $appointment->location_id }})
    ...
    <script>
        ...
        const handleSubmitForm = (event) => {
            ...
            $("input:checkbox[name=attendance_days]:checked").each(function() {
                attendance_days.push(Number($(this).val()));
            });
            ...
            $.ajax({
                type: 'PUT',
                url: "/dashboard/appointment/" + '{{ $appointment->id }}',
                headers: {
                ...
                success: function(data) {
                    notyf.success('تم تعديل خطة الدوام بنجاح')
        ...
        var selected_emps = JSON.parse('{{ $appointment->getEmployeesIds() }}')

        selected_emps.forEach(id => {
