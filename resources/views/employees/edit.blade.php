            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('employees.update', $emp->id) }}" method="post" autocomplete="off"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" id="inputPhone"
                                    placeholder="phone number" value="{{ $emp->phone }}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" class="form-control" id="inputAddress"
                                    placeholder="1234 Main St" value="{{ $emp->address }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="job_id" id="inputJob" class="selectize-drop-header"
                                    ...
                                    @foreach ($jobs as $job)
                                        <option {{ $emp->job_id == $job->id ? 'selected' : '' }} value="{{ $job->id }}">
                                            {{ $job->name }}</option>
                                    @endforeach
                                </select>
                            </div>
