...
@section('content')
    ...
    <div class="container-fluid">
                        ...
                        <div class="col-sm-3">
                            <div class="nav flex-column nav-pills nav-pills-tab" id="v-pills-tab2" role="tablist"
                                ...
                                <a class="nav-link active show mb-1" id="v-pills-home-tab2" data-toggle="pill"
                                    ...
                                    Home</a>
                                <a class="nav-link mb-1" id="v-pills-profile-tab2" data-toggle="pill"
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <p>
                    <a class="btn btn-primary waves-effect waves-light" data-toggle="collapse" href="#collapseExample"
