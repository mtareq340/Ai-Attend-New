                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('devices.index')}}">Extra Time</a></li>
                            <li class="breadcrumb-item active">Edit Extra Time</li>
    
                        </ol>
                    </div>
                    <h4 class="page-title">Edit Extra Time</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
