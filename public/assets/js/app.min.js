...
!(function ($) {
    ...
    (function ($) {
        ...
        (LayoutThemeApp.prototype._saveConfig = function (newConfig) {
            ...
            localStorage.setItem("theme", JSON.stringify(this.config));
        }),
            /**
        ...
        (LayoutThemeApp.prototype.loadConfig = function () {
            var config = {};
            var prev_conf = localStorage.getItem("theme");
            if (prev_conf) {
                config = JSON.parse(prev_conf);
            } else {
                config = $.extend(
                    {},
                    {
            ...
            (LayoutThemeApp.prototype.applyConfig = function () {
                ...
                var sidebar_config = this.config.sidebar;
                // activate menus
                ...
                // left sidebar
                var sidebarConfig = $.extend({}, this.config.sideSubMenus);
